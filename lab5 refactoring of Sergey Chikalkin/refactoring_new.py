...
def g (a, d, x, y):
    '''
    функция, рисующая лепесток с характерным размером d с координатами
...
def cir(a, scr):
    '''
    функция, рисующая 1 круг с ромашками диаметром a на пов-сти scr
    '''   
    b = [0] * 5
